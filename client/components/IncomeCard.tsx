          ...
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 550 188">
            ...
            <defs>
              <linearGradient id="greenGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style={{stopColor: "#CCFFCD", stopOpacity: 1}} />
                <stop offset="100%" style={{stopColor: "#CCFFCD", stopOpacity: 0}} />
              </linearGradient>
            </defs>
            {/* Point indicator */}
            <circle cx="275" cy="90" r="8" fill="black" stroke="white" strokeWidth="4" />
